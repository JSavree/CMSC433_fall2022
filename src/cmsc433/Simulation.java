...
public class Simulation {
	...
	public static Semaphore numberOfTablesAvailable;
	public static HashMap<Food, Machines> machinesMap; // machines used by cooks
	public static LinkedList<Order> orderQueue; // orders made by customers, read by cooks
	//Order's = List<Food>
//	private class Order {
//		
//	}
	...
	public static List<SimulationEvent> runSimulation(
		...
		numberOfTablesAvailable = new Semaphore(numTables, true);
		machinesMap = new HashMap<Food, Machines>();
